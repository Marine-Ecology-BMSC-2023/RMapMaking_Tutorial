...
VI_baselayer <- readOGR(dsn = here::here("Data/CAN_adm", ""), stringsAsFactors = F)
...
ggplot(VI_baselayer_sf) +
geom_polygon(data = VI_baselayer, 
...
(basemap <- ggplot(VI_baselayer_sf) +
geom_polygon(data = VI_baselayer, 
          aes(x = long, y = lat, group = group), 
...
(VI_Inset <- ggplot(data = VI_baselayer_sf) +
  geom_sf() +
